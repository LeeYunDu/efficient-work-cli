...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props2, { emit: __emit2 }) {
    ...
    function init2() {
      ...
      editorInstance2.value = editor;
      onTransformClick2(state2.model);
    }
    ...
    function onTransformDetail2() {
      editorInstance2.value.set(cloneDeep(props2.componentOptions));
    }
    function onSave2() {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_dialog, mergeProps({
        ...
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="button-box" data-v-89c1b198${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_button_group, null, {
              default: withCtx((_22, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_el_button, {
                    type: "warning",
                    onClick: ($event) => onTransformClick2("detail")
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`详细模式`);
            ...
            _push2(`<div class="tip" data-v-89c1b198${_scopeId}>${ssrInterpolate(tip2.value)}</div></div><div id="json-edit-container" data-v-89c1b198${_scopeId}></div>`);
          } else {
            return [
...
const JSONEdit = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-89c1b198"]]);
      ...
      _push(ssrRenderComponent(_component_el_dialog, mergeProps({
        ...
        default: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_button, {
              ...
              default: withCtx((_22, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    createTextVNode("init")
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`<div class="button-box" data-v-05dd2c60${_scopeId}>`);
            _push2(ssrRenderComponent(_component_el_radio_group, {
            ...
            _push2(`</div><div class="tip" data-v-05dd2c60${_scopeId}>${ssrInterpolate(tip.value)}</div>`);
            ...
            if (unref(state).model == "json") {
              _push2(`<div id="json-edit-container" data-v-05dd2c60${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const JSONPanel = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-05dd2c60"]]);
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props2, { emit: __emit2 }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_el_form_item = resolveComponent("el-form-item");
      const _component_el_input = resolveComponent("el-input");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "setting-page" }, _attrs))} data-v-ef3f1cea>`);
      ...
      _push(`<div class="collapse-list" data-v-ef3f1cea><!--[-->`);
      ssrRenderList(unref(state2).viewFields, (fields2, index) => {
        _push(`<div class="collapse-item" data-v-ef3f1cea><div class="header" data-v-ef3f1cea><div class="order" data-v-ef3f1cea>${ssrInterpolate(fields2.orderNum)}</div><div class="name" data-v-ef3f1cea>${ssrInterpolate(fields2.name)}</div><div class="key" data-v-ef3f1cea>`);
        ...
        _push(`</div><div class="button-group" data-v-ef3f1cea>`);
        _push(ssrRenderComponent(_component_el_popover, {
          ...
          reference: withCtx((_2, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="button-item" data-v-ef3f1cea${_scopeId}>快速编辑</div>`);
            } else {
              return [
                createVNode("div", {
                  class: "button-item",
          ...
          default: withCtx((_2, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<div class="flex f-jcfe" style="${ssrRenderStyle({ "text-align": "right" })}" data-v-ef3f1cea${_scopeId}>`);
              _push2(ssrRenderComponent(_component_el_button, {
                type: "text",
                onClick: ($event) => {
                  fields2._show = false;
        ...
        _push(`<div class="button-item" data-v-ef3f1cea>复制</div><div class="button-item" data-v-ef3f1cea>JSON编辑</div>`);
        if (unref(state2).showPanel && unref(state2).activeField.id == fields2.id) {
          _push(`<div class="button-item" data-v-ef3f1cea> 收起</div>`);
        } else {
          _push(`<div class="button-item" data-v-ef3f1cea> 编辑</div>`);
        }
        _push(`<div class="button-item" data-v-ef3f1cea>删除</div></div></div>`);
        if (unref(state2).showPanel && unref(state2).activeField.id == fields2.id) {
          _push(`<div class="main" data-v-ef3f1cea>`);
...
const FieldSetting = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-ef3f1cea"]]);
