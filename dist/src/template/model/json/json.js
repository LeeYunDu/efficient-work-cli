...
exports.sortOptions = exports.detailFields = exports.formOptions = exports.formFields = exports.tableColumn = exports.tableQueryFormOptions = exports.tableQueryFormFields = void 0;
const store_1 = __importDefault(require("@/store"));
const lodash_es_1 = require("lodash-es");
const vue_1 = require("vue");
const dictData = (0, vue_1.computed)(() => store_1.default.getters.dictData).value;
const tableQueryFormFields = (params) => {
    let fields = [
        {
        ...
        { label: '场景类型', key: 'y2', type: 'select', options: (0, lodash_es_1.get)(dictData, 'dict_area.tree', []) },
        {
        ...
        return (0, lodash_es_1.get)(field, 'show', true);
    });
    return fields;
};
exports.tableQueryFormFields = tableQueryFormFields;
...
const formFields = (params) => {
    return [
        ...
        return (0, lodash_es_1.get)(item, 'show', true);
    });
};
